...
<main class="container ms-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{route('user.list')}}" class="btn btn-gray-800 d-inline-flex align-items-center">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama" name="name" type="text"  required value={{old('nama')}} >
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="email" name="email" type="text"  required value={{old('email')}}>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control" id="tgl_lahir" name="tgl_lahir" type="date" placeholder="dd/mm/yyyy" required value={{old('tgl_lahir')}}>
                     </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
