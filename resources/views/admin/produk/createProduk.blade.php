    ...
    <main class="container ms-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <p class="mb-0"> Form tambah data Produk baru </p>
            </div>
            <div class="btn btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('produk.list') }}" class="btn btn-gray-800 d-inline-flex align-items-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input data-datepicker="" class="form-control" id="tgl_masuk" name="tgl_masuk" type="date"
                                placeholder="dd/mm/yyyy" required value={{ old('tgl_masuk') }}>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input data-datepicker="" class="form-control" id="tgl_expired" name="tgl_expired"
                                type="date" placeholder="dd/mm/yyyy" required value={{ old('tgl_expired') }}>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="Mitra" name="Mitra" type="text" required
                                value={{ old('Mitra') }}>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
