...
<main class="container ms-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{route('mitra.list')}}" class="btn btn-gray-800 d-inline-flex align-items-center">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama_mitra" name="nama_mitra" type="text"  required value={{old('nama_mitra')}} >
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control" id="tanggal_bergabung" name="tanggal_bergabung" type="date" placeholder="dd/mm/yyyy" required value={{old('tanggal_bergabung')}}>
                     </div>
                </div>

                <div class="col-md-6 mb-3">
                    <label for="gender">Jenis mitra</label>
                    <select class="form-select mb-0" id="jenisMitra" name="jenisMitra" aria-label="jenisMitra">
