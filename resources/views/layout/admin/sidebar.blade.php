<div class="sidebar" data-background-color="dark">
    <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo ms-5 mt-4">
                <img src="{{ asset('aset-admin/img/gambarlogo1.png') }}" height="100" />
            </a>
            ...
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item {{request()->is('user*') ? 'active' : ''}}">
                    <a href="{{ route('user.list') }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-person-vcard me-2" viewBox="0 0 16 16">
                            <path
                ...
                <li class="nav-item {{request()->is('produk*') ? 'active' : ''}}">
                    <a href="{{ route('produk.list') }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-archive me-2" viewBox="0 0 16 16">
                            <path
